...
@property (assign, nonatomic) CGFloat shadowOpacity UI_APPEARANCE_SELECTOR;                 // default is .5
//@property (assign, nonatomic) CGFloat shadowRadius UI_APPEARANCE_SELECTOR;                  // default is 3
@property (assign, nonatomic, nonnull) CGSize *shadowOffset UI_APPEARANCE_SELECTOR;         // default is 0,0

@property (strong, nonatomic, nonnull) UIColor *shadowColor UI_APPEARANCE_SELECTOR;         // default is [UIColor blackColor]
...
+ (void)setShadowOpacity:(CGFloat)shadowOpacity;                    // default is 1

//+ (void)setShadowRadius:(CGFloat)shadowRadius;                      // default is 3

+ (void)setShadowOffset:(CGSize)shadowOffset;                       // default is 0,0

+ (void)setShadowColor:(nonnull UIColor *)shadowColor;              // default is [UIColor blackColor]
